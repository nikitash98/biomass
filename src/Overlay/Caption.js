...
The units are in gigatons of carbon – abbreviated Gt C.
        ...
        case 11:
            return <div>
                <h3>
                    ...
                    <HoverSpan id = "fish_text" hover_id = "Mollusks" setHovered = {setHovered}>mollusks</HoverSpan>  <HoverSpan id = "fish_text" hover_id = "Cnidarians" setHovered = {setHovered}>cnidarians</HoverSpan> and   <HoverSpan id = "fish_text" hover_id = "Marine_Arthropods" setHovered = {setHovered}>marine arthropods</HoverSpan>.
                </h3>
            </div>
        case 12:
            return <div>
                <h3>
                We then find an abundance of life forms  underground (<HoverSpan id = "fish_text" hover_id = "Arthropods" setHovered = {setHovered}>terrestrial arthropods</HoverSpan>, 
                <HoverSpan id = "fish_text" hover_id = "Nematodes" setHovered = {setHovered}>nematodes</HoverSpan> and 
                <HoverSpan id = "fish_text" hover_id = "Annelids" setHovered = {setHovered}>annelids</HoverSpan>).
                </h3>
            </div>
        case 13:
            return <div>
        ...
        case 14:
            return <div>
                <h3>
                <HoverSpan id = "fish_text" hover_id = "Wild_Mammals" setHovered = {setHovered}>Wild mammals</HoverSpan> and   <HoverSpan id = "fish_text" hover_id = "Wild_Birds" setHovered = {setHovered}>birds</HoverSpan>
