...
function Animation(props) {
  ...
  function applyMask(material, maskID) {
  ...
  const rise_percentage = (value) => {
    let start_time = slides[22]["animationTime"]
  ...
  useFrame((state, delta)=> {
    ...
    if([22, 23].includes(props.counter)) {
      props.setYearPercentage(flatYear(animationTime.current))
      quant_value.current = rise_percentage(animationTime.current)
      asphalt_value.current = exponentialLaw(0.210, 4.488,rise_percentage(animationTime.current) * 3 + 1)
        aggregate_value.current = exponentialLaw(4.739, 2.966,rise_percentage(animationTime.current) * 3 + 1)
        brick_value.current = exponentialLaw(4.587, 2.000,rise_percentage(animationTime.current) * 3 + 1)
        metal_value.current = exponentialLaw(0.277, 3.475,rise_percentage(animationTime.current) * 3 + 1)
        concrete_value.current = exponentialLaw(0.270, 6.684,rise_percentage(animationTime.current) * 3 + 1)
      ...
      */}  
      {(props.counter == 1) && (
        ...
        geometry={nodes.Arthropods.geometry} material={highlighted.includes("Arthropods") ? plant_material : materials["Material.005"]} position={[0.16, -100, -0.06]} rotation={[Math.PI / 2, 0, 0]} onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
          ...
          <Html zIndexRange={[0, 100]} center = {true} position = {[0, 0, -.6]} className="box_value">
            <h1>{data["Arthropods"].weight} Gt</h1>
            </Html>
          }
        </mesh>
        ...
        <mesh name="Cnidarians" 
         ...
         geometry={nodes.Cnidarians.geometry} material={highlighted.includes("Cnidarians") ? plant_material : materials["Material.002"]} position={[0, -100, -0.06]} rotation={[Math.PI / 2, 0, 0]} onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
          ...
          <Html center = {true} position = {[0, 0, -.8]} className="box_value">
            <h1>{data["Cnidarians"].weight} Gt</h1>
            </Html>
          }
        </mesh>
        ...
        geometry={nodes.Fish.geometry} material={highlighted.includes("Fish") ? plant_material : materials["Material.001"]} position={[-0.03, -100, -0.06]} 
        rotation={[Math.PI / 2, Math.PI / 2, 0]} onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
          ...
          <Html zIndexRange={[0,100]} center = {true} position = {[1, 0, 0]} className="box_value">
            <h1>{data["Fish"].weight} Gt</h1>
            </Html>
          }
        </mesh>
        ...
        geometry={nodes.Humans.geometry} material={highlighted.includes("Humans") ? plant_material : materials["Material.003"]} position={[-0.17, -100, -0.07]} 
        rotation={[Math.PI / 2, 0, 0]} onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
          ...
          zIndexRange={[0, -20]}
          ><h1>Humans</h1></Html>
          {((props.hovered[0] == "Humans" || quantities.includes("Humans"))) && 
        ...
        geometry={nodes.Livestock.geometry} material={highlighted.includes("Livestock") ? plant_material : materials["Material.003"]} position={[0.29, -100, -0.07]} rotation={[Math.PI / 2, 0, 0]} onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
          ...
          position = {[0, 0, -.4]} className="box_value">
            <h1>{data["Livestock"].weight} Gt</h1>
            </Html>
          }
        </mesh>
        ...
        geometry={nodes.Marine_Arthropods.geometry} material={highlighted.includes("Marine Arthropods") ? plant_material : materials["Material.002"]} position={[0.03, -100, -0.08]} rotation={[Math.PI / 2, 0, 0]} scale={1.07} onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
          ...
          <Html center = {true} position = {[0, 0, -1]} className="box_value">
            <h1>{data["Marine Arthropods"].weight} Gt</h1>
            </Html>
          }
        </mesh>
        ...
        ref = {ref => divRefs.current["Mollusks"] = ref}
         geometry={nodes.Mollusks.geometry} material={highlighted.includes("Mollusks") ? plant_material : materials["Material.001"]} position={[-0.08, -100, -0.07]} rotation={[Math.PI / 2, 0, 0]} onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
          ...
          <Html  center = {true} position = {[0, 0, -0.7]} className="box_value">
            <h1>{data["Mollusks"].weight} Gt</h1>
          </Html>
          }
        </mesh>
        ...
        geometry={nodes.Nematodes.geometry} material={highlighted.includes("Nematodes") ? plant_material : materials["Material.005"]} position={[-0.01, -100, -0.4]} rotation={[Math.PI / 2, 0, 0]} onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
          ...
          <Html position = {[-.3, .1, .2]} zIndexRange={[0, -20]} className={hiddenClass}><h1>Nematodes</h1></Html>
          ...
          style={{
           ...
           position = {[0, 0, -.4]} className="box_value">
            <h1>{data["Nematodes"].weight} Gt</h1>
            </Html>
          }
        ...
        geometry={nodes.Wild_Birds.geometry} material={highlighted.includes("Wild Birds") ? plant_material : materials["Material.003"]} position={[-0.07,-100, -0.07]} rotation={[Math.PI / 2, 0, 0]} onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
          ...
          className="box_value">
            <h1>{data["Wild Birds"].weight} Gt</h1>
            </Html>
          }
        </mesh>
        ...
        geometry={nodes.Wild_Mammals.geometry} material={highlighted.includes("Wild Mammals") ? plant_material : materials["Material.003"]} position={[-0.32, -100, -0.07]} rotation={[Math.PI / 2, 0, 0]}  onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
          ...
          className="box_value">
            <h1>{data["Wild Mammals"].weight} Gt</h1>
            </Html>
          }
        </mesh>
        ...
        receiveShadow castShadow geometry={nodes.Archaea.geometry} material={highlighted.includes("Archaea") ? plant_material : materials.Bacteria} position={[6.42, 2, -31.01  + 30]} rotation={[Math.PI / 2, 0, 0]}  onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
          ...
          <Html center = {true} position = {[0, 0, -1.6]} className="box_value">
            <h1>{data["Archaea"].weight} Gt</h1>
        ...
        receiveShadow  castShadow geometry={nodes.Bacteria.geometry} material={highlighted.includes("Bacteria") ? plant_material : materials.Bacteria} position={[4.63, 3.14, -34.55  + 30]} rotation={[Math.PI / 2, 0, 0]}  onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
          ...
          <Html center = {true} position = {[0,0,-2.7]} className="box_value">
            <h1>{data["Bacteria"].weight} Gt</h1>
            </Html>
          }
        </mesh>
        ...
        receiveShadow castShadow geometry={nodes.Fungi.geometry} material={highlighted.includes("Fungi") ? plant_material : materials.Fungi} position={[-0.72, 2.19, -31.07  + 30]} rotation={[Math.PI / 2, -Math.PI / 2, 0]}  onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
          ...
          {props.hovered[0] == "Fungi" && 
            <Html center = {true} position = {[-1.8, 0, 0]} className="box_value">
            <h1>{data["Fungi"].weight} Gt</h1>
              </Html>
          }
        </mesh>
        ...
        receiveShadow castShadow geometry={nodes.Plants.geometry} material={highlighted.includes("Plants") ? plant_material : materials.Plants} position={[-4.04, 4.81, -36.51  + 30]} rotation={[Math.PI / 2, -Math.PI / 2, 0]} scale={3.36} onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
          ...
          {props.counter > 27 &&
            <Html position = {[-1.3, +1, +0.5]}className={highlighted.includes("Plants") ? hiddenClass + " unhighlighted" :hiddenClass}><h1>Plants</h1></Html>
          }
          {props.counter < 9 &&
            <Html position = {[+1.2, +1, +1.2]}className={highlighted.includes("Plants") ? hiddenClass + " unhighlighted" :hiddenClass}><h1>Plants</h1></Html>
          }

          {props.hovered[0] == "Plants" && 
            <Html center = {true} position = {[-1.5, 0, 0]} className="box_value">
            <h1>{data["Plants"].weight} Gt</h1>
              </Html>
          }
        ...
        receiveShadow v castShadow geometry={nodes.Animals.geometry} material={highlighted.includes("Animals") ? plant_material : materials.Animals} 
        
        position={[0.73, 1.75, -29.04  + 30]} rotation={[Math.PI / 2, -Math.PI / 2, 0]} scale={0.63} onPointerOver = {handleHover} onPointerOut = {handleUnhover} frustumCulled = {false} onClick={animal_click}>
          ...
          {props.counter == 11  &&
            <Html position = {[-2.4, 1, 1.2]} onClick={() => {props.setCounter(props.counter + 1)}}>Open the box</Html>
          }
          {/* center = {true}  center = {true} */}
          {props.hovered[0] == "Animals"  && 
        ...
        geometry={nodes.Virus.geometry} material={highlighted.includes("Viruses") ? plant_material : materials.Material} position={[9.45, 1.43, 2.44]} rotation={[Math.PI / 2, 0, 0]} onPointerOver = {handleHover} onPointerOut = {handleUnhover}> 
          ...
          <Html center = {true} position = {[0, 0, -.7]} className="box_value">
            <h1>{data["Virus"].weight} Gt</h1>
            </Html>
          }
        </mesh>
        ...
        material={materials['Material.004']} position={[1.83, -7.41, 1.37]} scale={0.51} onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
          ...
          {props.hovered[0] == "LUCA" && 
          <Html center = {true} position = {[0, 0, -.7]} className="box_value">
            <h1>{data["LUCA"].weight} Gt</h1>
            </Html>
          }
        </mesh>
        ...
        <group ref = {globeRef} >
          <mesh name="Globe" ref = {hoverGlobeRef} geometry={nodes.Globe.geometry} material={materials.Globe} position={[0.68, 13.43, 0]} rotation={[1.96, -0.05, 0.02]} scale={9.47} 
          onPointerOver={globeHover}  onPointerOut = {globeUnhover} onClick={()=>{props.setCounter(props.counter+1)}}>
          </mesh>
        </group>
            <Html className='click_info_box' position={[0, 9, 0]} 
            ...
            <Html position={[0, 12, 0]} >
              <img src = "images/Animals.png"></img>
            </Html>
        </group>
        ...
        <mesh name="Concrete" 
          ...
          position={[-3.18, 4.89, 62.75]} rotation={[0, -Math.PI / 2, 0]} scale={6.5}
          onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
...
{![22, 23].includes(props.counter)&& (
          ...
          {props.counter >= 22 && props.counter <24 && (
            <Html position = {[-0.5, .66, 0]} className={highlighted.includes("Protists") ? hiddenArtificial + " unhighlighted" :hiddenArtificial}><h1>Concrete</h1></Html>
          )}
        ...
        {(props.hovered[0] == "Concrete"|| quantities.includes("Concrete")) && 
          ...
          >
            {[22, 23].includes(props.counter) && (
              ...
              {Math.round(concrete_value.current).toString()} Gt
              </h1>
        ...
        <mesh name="Bricks"
         ...
         position={[11.64, 3.1, 39.4]} rotation={[0, -Math.PI / 2, 0]} scale={3.58}
         onPointerOver = {handleHover} onPointerOut = {handleUnhover}>

          {props.counter < 29 && ![22, 23].includes(props.counter) && (
            <Html position = {[.5, -.5, .5]} className={highlighted.includes("Protists") ? hiddenArtificial + " unhighlighted" :hiddenArtificial}>
              <h1>Bricks</h1>
              </Html>
          )}

          {props.counter >= 29 && (
            <Html position = {[.5, .7, .5]} className={highlighted.includes("Protists") ? hiddenArtificial + " unhighlighted" :hiddenArtificial}>
              <h1>Bricks</h1>
              </Html>
          )}

          {props.counter >= 22 && props.counter <24 && (
            <Html position = {[-0.5, .7, 0]} className={highlighted.includes("Protists") ? hiddenArtificial + " unhighlighted" :hiddenArtificial}><h1>Bricks</h1></Html>
          )}
          ...
          >
            {[22, 23].includes(props.counter) && (
              ...
              {Math.round(brick_value.current).toString()} Gt
              </h1>
        ...
        rotation={[0, -Math.PI / 2, 0]} scale={[2.69, 2.55, 2.55]}
        onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
          ...
          {props.counter >= 22 && props.counter <24 && (
            <Html position = {[-0.35, .7, 0]} className={highlighted.includes("Protists") ? hiddenArtificial + " unhighlighted" :hiddenArtificial}><h1>Metals</h1></Html>
          )}
          ...
          >
            {[22, 23].includes(props.counter) && (
              ...
              {Math.round(metal_value.current).toString()} Gt
              </h1>
        ...
        position={[4.1, 4.48, 50.63]} rotation={[0, -Math.PI / 2, 0]} scale={5.78}
        onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
        ...
        {(props.hovered[0] == "Aggregates"|| quantities.includes("Aggregates")) && 
          ...
          >
            {[22, 23].includes(props.counter) && (
              ...
              {Math.round(aggregate_value.current).toString()} Gt
              </h1>
        ...
        <Html position = {[.5, -.5, .5]} className={highlighted.includes("Protists") ? hiddenArtificial + " unhighlighted" :hiddenArtificial}>  <h1>Aggregates</h1>
        </Html>
        )}
          {props.counter >= 22 && props.counter <24 && (
            <Html position = {[-0.3, .68, 0]} className={highlighted.includes("Protists") ? hiddenArtificial + " unhighlighted" :hiddenArtificial}><h1>Aggregates</h1></Html>
          )}
        ...
        */}
        ...
        <mesh name="Asphalt" 
            ...
            position={[16.88, 2.98, 31.73]} rotation={[0, -Math.PI / 2, 0]} scale={3.19}
            onPointerOver = {handleHover} onPointerOut = {handleUnhover}>
          {props.counter < 29 && ![22, 23].includes(props.counter)  && (
          ...
          {props.counter >= 22 && props.counter <24 && (
            <Html position = {[-0.4, .7, 0]} className={highlighted.includes("Protists") ? hiddenArtificial + " unhighlighted" :hiddenArtificial}><h1>Asphalt</h1></Html>
          )}
          ...
          >
            {[22, 23].includes(props.counter) && (
              ...
              {Math.round(asphalt_value.current).toString()} Gt
              </h1>
            ...
            {![22, 23].includes(props.counter) && (
              <h1>
                {data["Asphalt"].weight} Gt
              </h1>
            )}          </Html>
        }
          <mesh name="Plane010" geometry={nodes.Plane010.geometry} material={materials['Material.008']} position={[0.02, 0.02, 0.58]} rotation={[Math.PI / 2, 0, 0]} scale={1.22} />
        ...
        */}
        ...
        <mesh position={[17.87, 5.56, -17.03]} rotation={[0, 0.52, 0]}>
          <boxBufferGeometry attach="geometry" args={[8, 8, 8]}/>
          <meshNormalMaterial attach="material" />
        </mesh>
        <mesh name="Cube004" geometry={nodes.Cube004.geometry} material={nodes.Cube004.material}
         position={[17.87, 5.56, -17.03]} rotation={[0, 0.52, 0]} scale={3.96}
         />

        */}
        <Mask id = {1} position={[17.87, 5.56, -17.03]} rotation={[0, 0.52, 0]}>
